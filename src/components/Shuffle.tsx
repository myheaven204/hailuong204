...
import React, { useRef, useEffect, useState, useMemo, type CSSProperties, type ElementType } from 'react';
  ...
  useGSAP(
    () => {
      ...
      if (userHasFont) {
        ...
        computedFont = `'Roboto Flex', sans-serif`;
      }
      ...
      const build = () => {
        ...
        const inners = () => wrappersRef.current
