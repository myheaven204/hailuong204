...
function Hero() {
  ...
  return (
    ...
    >
      ...
      >
        {/* Title */}
        <div className="relative w-full px-4 sm:px-6 flex flex-col items-center pointer-events-none" style={{ marginTop: 'clamp(60px, 10vh, 120px)', marginBottom: 'clamp(12px, 1.5vh, 24px)' }}>
          <ContainerTextFlip
